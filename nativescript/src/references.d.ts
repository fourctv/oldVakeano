...
/// <reference path="../node_modules/@types/jquery/index.d.ts" /> Needed for autocompletion and compilation.
/// <reference path="../node_modules/@types/kendo-ui/index.d.ts" /> Needed for autocompletion and compilation.
