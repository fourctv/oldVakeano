...
export class People extends FourDModel {
	...
	fields:Array<any> = [
		{name:'PeopleID', longname:'People.PeopleID', type:'number', required:true, readonly:true},
		...
		{name:'IMDBID', longname:'People.IMDBID', type:'string', required:true},
		{name:'FirstName', longname:'People.FirstName', type:'string'},
		{name:'LastName', longname:'People.LastName', type:'string'},
		{name:'DOB', longname:'People.DOB', type:'Date'},
		{name:'DOD', longname:'People.DOD', type:'Date'},
		{name:'Awards', longname:'People.Awards', type:'string'},
		{name:'Biography', longname:'People.Biography', type:'string'}
	];
