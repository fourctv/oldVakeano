...
export class Seasons extends FourDModel {
	...
	fields:Array<any> = [
		{name:'SeasonId', longname:'Seasons.SeasonId', type:'number', required:true, readonly:true},
		{name:'IMDBID', longname:'Seasons.IMDBID', type:'string'},
		{name:'IMDBTitle', longname:'Seasons.IMDBTitle', type:'string', required:true},
		{name:'ProdYear', longname:'Seasons.ProdYear', type:'number'},
		{name:'ProductionTitle', longname:'Seasons.ProductionTitle', type:'string'},
		{name:'ThemeVector', longname:'Seasons.ThemeVector', type:'string'},
		{name:'NarrativeVector', longname:'Seasons.NarrativeVector', type:'string'},
		{name:'ContentVector', longname:'Seasons.ContentVector', type:'string'},
		{name:'ExecutionVector', longname:'Seasons.ExecutionVector', type:'string'},
		{name:'StyleVector', longname:'Seasons.StyleVector', type:'string'},
		...
		{name:'SeasonNumForDisplay', longname:'Seasons.SeasonNumForDisplay', type:'string'},
		{name:'SeriesID', longname:'Seasons.SeriesID', type:'number', required:true},
		{name:'ActingType', longname:'Seasons.ActingType', type:'string', required:true},
		{name:'NarrativeType', longname:'Seasons.NarrativeType', type:'string', required:true}
	];
