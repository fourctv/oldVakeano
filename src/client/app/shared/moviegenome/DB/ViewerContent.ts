...
export class ViewerContent extends FourDModel {
	...
	fields:Array<any> = [
		...
		{name:'FeatureID', longname:'ViewerContent.FeatureID', type:'number'},
		{name:'SeasonID', longname:'ViewerContent.SeasonID', type:'number'},
		{name:'SeriesID', longname:'ViewerContent.SeriesID', type:'number'},
		{name:'MGCCI', longname:'ViewerContent.MGCCI', type:'number'},
		{name:'UserID', longname:'ViewerContent.UserID', type:'number', required:true},
		{name:'Feedback_Theme', longname:'ViewerContent.Feedback_Theme', type:'string'},
		{name:'ProfileID', longname:'ViewerContent.ProfileID', type:'number', required:true},
